...
public class AddressBookDisplay extends JFrame
{
   ...
   {
      super("Address Book - Ka Shing Wai");
   ...
   private void previousButtonActionPerformed(ActionEvent evt)
   {
      ...
      indexTextFieldActionPerformed(evt);
      deleteIndex = Integer.parseInt(idTextField.getText());
   }
   ...
   {
      results =
         personQueries.getPeopleByState(queryTextField.getText());
   ...
   {
      int result = personQueries.deletePerson(deleteIndex);
   ...
   private void updateButtonActionPerformed(ActionEvent evt)
   {
      int result = personQueries.updatePerson(
              deleteIndex,firstNameTextField.getText(),
              lastNameTextField.getText(), emailTextField.getText(),
              phoneTextField.getText(),stateTextField.getText());
      ...
      if (result == 1)
         ...
         JOptionPane.showMessageDialog(this, "Database not update!",
                 "Error", JOptionPane.CANCEL_OPTION);

      browseButtonActionPerformed(evt);
   }

   public int getAddressID(){return Integer.parseInt(idTextField.getText());}
